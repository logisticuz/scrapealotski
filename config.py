...
SCRAPE_CATEGORY_IDS = _env_int_csv("SCRAPE_CATEGORY_IDS", [])
...
SCRAPE_OUTPUT_DIR = os.getenv("SCRAPE_OUTPUT_DIR", "")
SCRAPE_MEDIA_DIR = os.getenv("SCRAPE_MEDIA_DIR", "")
...
LOG_ERROR_PATH = os.getenv("LOG_ERROR_PATH", "scrape_errors.log")
LOG_JSON = _env_bool("LOG_JSON", False)
LOG_JSON_PATH = os.getenv("LOG_JSON_PATH", "scrape_metrics.jsonl")
